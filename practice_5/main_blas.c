...
void multiplyMatrices(float *A, float *B, float *resultMatrix, int matrixSize) {
    cblas_sgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, matrixSize, matrixSize, matrixSize, 1.0, A, matrixSize, B, matrixSize, 0.0, resultMatrix, matrixSize);
}

void scaleMatrix(float *A, float scale, float *resultMatrix, int matrixSize) {
    cblas_sscal(matrixSize * matrixSize, scale, A, 1);
    cblas_scopy(matrixSize * matrixSize, A, 1, resultMatrix, 1);
}

void addMatrices(float *A, float *B, float *resultMatrix, int matrixSize) {
    cblas_scopy(matrixSize * matrixSize, A, 1, resultMatrix, 1);
    cblas_saxpy(matrixSize * matrixSize, 1.0f, B, 1, resultMatrix, 1);
}
